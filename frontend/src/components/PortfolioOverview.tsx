...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon: Icon, title, value }) => (
    <motion.div
      ...
      className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 p-4 md:p-6 rounded-xl shadow-lg"
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="ml-2 md:ml-4">
            ...
            <p className="text-base md:text-lg font-semibold text-gray-900 dark:text-white">{value}</p>
          </div>
        </div>
      </div>
    </motion.div>
